...
create table product(id serial primary key,Name text, description text, image text, price numeric(15,6) not null, quantity int,category_id int references category(id));
