...
<%  session= request.getSession(false);
    ...
    //System.out.println("d "+ids.get(0));
    count=(ArrayList<Integer>)session.getAttribute("count");
    try{
...
%>
    <body>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="check_out.jsp" class="nav-item nav-link">Checkout</a>
        ...
        res = stmt.executeQuery("select name,price from product where id =" + ids.get(i) + ";");
        res.next();
        out.println("<tr>\n"
                + " \n"
                + " <td>\n"
                ...
                + " </div>\n"
                + " </td>\n"
                + " <td>$" + count.get(i)*res.getInt(2) + "</td>\n"
 ...
 %>
        ...
        <%                      
                                ...
                                response.sendRedirect("Excep.html"); 
